...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
	...
	#Inject for each value of array applay computation of bloock and save them in accumulator
	#in this case it's a product. And than return the value of product. 
	#Item is just a value we puts in the block when we call inject.
  end
  ...
  # We do computation on data from the file and we don't use this file againe in the code.
  # And we don't need to close it. 
  #   file = File.open(filename)
  #   # code to read 'file'
  #In this case we need enshure to close the file.
