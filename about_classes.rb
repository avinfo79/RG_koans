...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # Because new call initialize and all verible must be set, because initialize is method and we call it througth new.
    # And we can't call method if we not provide nesesery veribles.
  end
