...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Answ: Because send can be overiden but __send__ can't.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # Answ: It's not good idea redefine method_missing whout need, program pass the NoMethodErro and it's hard to find what's wrong.
    # NOTE:
    #
